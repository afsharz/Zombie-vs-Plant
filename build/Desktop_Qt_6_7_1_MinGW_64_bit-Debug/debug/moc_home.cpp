...
void home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->AddedToVec((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->zombiewin(); break;
        case 2: _t->ZomWin(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &home::AddedToVec; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (home::*)();
            if (_t _q_method = &home::zombiewin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void home::AddedToVec(QString _t1)
{
